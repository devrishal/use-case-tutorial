package com.rds.barcodegen.domain.service.impl;

import java.util.Locale;
import java.util.Map;

import com.rds.barcodegen.domain.service.xls.generic.AbstractDocumentService;
...
public class BarcodeDocumentServiceImpl extends AbstractDocumentService {
	...
	public void generatePDF(HttpServletRequest request, HttpServletResponse response) {
		...
		Context context = new Context(Locale.getDefault(), Map.of("model", Map.of("title",
				"BarCode Generation Using Apache FOP", "titleLine1", "and Barcode4J", "code39Message", data)));
